            ...
            signWindow === 'signUp' && (
                <>
                    <View style={[{gap: 10}]}>
                        ...
                        <TextInput style={[{borderBottomWidth: 3}, {borderBottomColor: 'rgb(141,26,244)'}]} placeholder='Choose a name for your account...' />
                    </View>

                    <View style={[{gap: 10}]}>
                        <Text style={{fontSize: 17}}>Phone Number:</Text>
                        <TextInput style={[{borderBottomWidth: 3}, {borderBottomColor: 'rgb(141,26,244)'}]} placeholder='Type your phone number...' />
                    </View>

                    <View style={[{gap: 10}]}>
                        <Text style={{fontSize: 17}}>Email:</Text>
                        <TextInput style={[{borderBottomWidth: 3}, {borderBottomColor: 'rgb(141,26,244)'}]} placeholder='Type your email...' />
                    </View>

                    <View style={[{gap: 10}]}>
                        <Text style={{fontSize: 17}}>Password:</Text>
                        <TextInput style={[{borderBottomWidth: 3}, {borderBottomColor: 'rgb(141,26,244)'}]} placeholder='Choose a strong password...' />
                    </View>

                    <Pressable style={[{backgroundColor: 'rgb(141,26,244)'}, {height: height / 15}, {borderRadius: 50}, {justifyContent: 'center'}, {alignItems: 'center'}]}>
