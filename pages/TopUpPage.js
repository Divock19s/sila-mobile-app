...
const TopUpPage = () => {
  ...
  return (
    <View style={[{flex: 1}, {paddingHorizontal: 30}]}>
        <View style={[{height: 70}, {backgroundColor: '#000'}, {borderBottomLeftRadius: 50}, {borderBottomRightRadius: 50}, {flexDirection: 'row'}, {justifyContent: 'center'}, {alignItems: 'center'}, {gap: 30}, {position: 'absolute'}, {left: 0}, {right: 0}]}>
        ...
        <Pressable onPress={() => setPaymentMethodPicker(!paymentMethodPicker)} style={[{borderWidth: 3}, {height: 70}, {flexDirection: 'row'}, {alignItems: 'center'}, {justifyContent: 'space-between'}, {paddingHorizontal: 30}, {borderRadius: 20}, {marginTop: 150}, {backgroundColor: '#000'}]}>
            {
                paymentMethod !== null ? (
        ...
        {
            paymentMethodPicker && (
                <View style={[{borderWidth: 3}, {borderRadius: 20}]}>
        ...
        <TextInput style={[{borderBottomWidth: 3}, {marginTop: 30}, {fontFamily: 'Ubuntu-Medium'}, {fontSize: 17}]} placeholder='Charge Amount, eg: 500' keyboardType='numeric' />

        <TextInput style={[{borderBottomWidth: 3}, {marginTop: 30}, {fontFamily: 'Ubuntu-Medium'}, {fontSize: 17}]} placeholder='Transaction ID' keyboardType='numeric' />
        ...
        <View style={[{flexDirection: 'row'}, {marginTop: 100}, {justifyContent: 'center'}, {gap: 20}]}>
            <Pressable style={[{paddingVertical: 20}, {paddingHorizontal: 60}, {borderRadius: 60}, {borderWidth: 3}]}>
                <Text style={[{fontSize: 17}, {fontFamily: 'Ubuntu-Regular'}]}>Cancel</Text>
            </Pressable>

            <Pressable style={[{backgroundColor: '#000'}, {paddingVertical: 20}, {paddingHorizontal: 60}, {borderRadius: 60}]}>
