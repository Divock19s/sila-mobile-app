...
const ServicesPage = () => {
  ...
  return (
    <View style={[{flex: 1}, {paddingHorizontal: 30}]}>
        <View style={[{borderBottomWidth: 4}, {justifyContent: 'center'}, {alignItems: 'center'}, {height: 100}, {borderColor: 'purple'}, {flexDirection: 'row'}, {gap: 20}]}>
        ...
        <Pressable onPress={() => navigation.navigate('ComingSoon')} style={[{flexDirection: 'row'}, {alignItems: 'center'}, {gap: 20}, {padding: 20}, {backgroundColor: 'purple'}, {marginTop: 30}, {borderRadius: 20}]}>
            ...
            <Text style={[{fontFamily: 'Ubuntu-Medium'}, {fontSize: 16}, {color: '#fff'}]}>Development (Apps & Websites)</Text>
        </Pressable>
